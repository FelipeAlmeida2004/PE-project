...
> **Apresentadores:** 6
> **Tempo médio por bloco:** 5–6 minutos
...
## Distribuição dos blocos (6 apresentadores)
...
| 6 | P6 | Relações entre variáveis (dispersão, contingência) e conclusão | ~5–6 min |
...
### Slide 5 — Como os dados foram capturados
...
### Slide 7 — Vieses inerentes à base
...
### Slide 8 — Limitações metodológicas do projeto
...
### Slide 9 — Classificação das variáveis analisadas
...
### Slide 10 — Checklist das análises realizadas
...
### Slide 11 — Tabela de Frequência: Renda Familiar (Q006)
...
### Slide 12 — Gráfico de Barras / Pizza: Renda Familiar
- Mostrar `barras_Q006.png` + `pizza_Q006.png`.
- Descrever: barra A é ~2,6× maior que B.

### Slide 13 — UF de Prova (Top 10)
...
### Slide 14 — Sexo (TP_SEXO)
- Mostrar `barras_TP_SEXO.png` e `pizza_TP_SEXO.png`.
- Ler proporção F / M.

### Slide 15 — Escolaridade dos pais (Q001 e Q002)
...
### Slide 16 — Língua Estrangeira (TP_LINGUA)
...
### Slide 23 — Comparativo: histogramas lado a lado
...
### Slide 24 — Tabela mestre de estatísticas descritivas
...
### Slide 25 — Tendência central: Média, Mediana, Moda
...
### Slide 26 — Dispersão: Variância e Desvio Padrão
...
# 🎤 BLOCO 6 — Relações entre Variáveis e Conclusão *(P6 — ~5–6 min)*

### Slide 30 — Diagrama de dispersão: CN × MT
...
### Slide 31 — Diagrama de dispersão: CH × LC
...
### Slide 32 — Diagrama de dispersão: MT × Redação
...
### Slide 33 — Tabela de contingência: Sexo × Renda
...
### Slide 34 — Tabela de contingência: Escolaridade da Mãe × Renda
...
|---|---|---|---|
| 1 — Intro / Captura | 1–6 | 5:00 | 5:00 |
| 2 — Vieses / Variáveis | 7–10 | 5:00 | 10:00 |
| 3 — Qualitativa | 11–16 | 5:00 | 15:00 |
| 4 — Contínua / Histogramas | 17–23 | 5:00 | 20:00 |
| 5 — Medidas-resumo / Boxplot | 24–29 | 6:00 | 26:00 |
| 6 — Relações / Conclusão | 30–36 | 6:00 | **32:00** |

Margem de 2–3 min para transições entre apresentadores e perguntas rápidas → encaixa em 30–35 min.
